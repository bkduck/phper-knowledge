...
* OOP 思想
* [抽象类、接口 分别使用场景](https://blog.csdn.net/qq_40592933/article/details/88813746)
* [Trait 是什么东西](http://php.net/manual/zh/language.oop5.traits.php)
* [echo、print、print_r 区别(区分出表达式与语句的区别)](https://blog.csdn.net/weixin_42545184/article/details/83443720)
...
* [Session 共享、存活时间](https://www.cnblogs.com/wenphp/p/4871500.html)
